...
export function Footer() {
  return (
    <footer className="bg-[#070B14] border-t border-white/[0.08] pt-16 pb-12 text-slate-400 text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/[0.06]">
          ...
          <div className="space-y-4">
            ...
            <div className="inline-flex items-center gap-1.5 text-[11px] font-mono text-emerald-400 font-medium bg-emerald-500/10 px-3 py-1 rounded-full border border-emerald-500/20">
          ...
          <div className="space-y-3">
            <div className="font-mono font-bold text-white uppercase tracking-wider text-xs">
              Navegação
            </div>
            <ul className="space-y-2">
              <li>
                <a href="#pilares" className="hover:text-amber-400 transition-colors">
                  Os 4 Pilares da Engenharia
                </a>
              </li>
              <li>
                <a href="#oferta" className="hover:text-amber-400 transition-colors">
              ...
              <li>
                <a href="#depoimentos" className="hover:text-amber-400 transition-colors">
